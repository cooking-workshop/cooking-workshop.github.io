  ...
  return (
    <div className="font-sans min-h-screen flex flex-col p-4">
      ...
      <main id="top" className="flex-1">
        {/* Hero */}
        <div className="flex-col mx-auto max-w-5xl bg-background/95">
          ...
          <section id="gifts" className="mt-16">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="mt-3 opacity-80">
                Special Russian treats and beverages. Click to explore each
                gift.
              </p>
              <GiftsAccordion />
            </div>
      ...
      <footer className="px-4 sm:px-6 py-6 border-t border-black/[.08] bg-background/95">
